# MIS
##一，1.数据库ER图
![all text](https://github.com/lzy199552/MIS/raw/master/ER图.png)
##2建表SQL
```（1）创建设备类型表
    CREATE TABLE `设备类型` (
...
```
![all text](https://github.com/lzy199552/MIS/raw/master/查询保养记录.png)
```

select * from 设备 as a inner join 保养记录 as b on a.设备ID=b.设备ID where a.设备ID="1"
```
![all text](https://github.com/lzy199552/MIS/raw/master/查询保养记录1.png)
```
